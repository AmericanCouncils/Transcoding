...
class HandbrakeTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCommandString()
    {
        ...
        $expected = sprintf("/good/path -i %s -o %s -e x264 -b 960 -a 1 -E faac -B 128 -6 dpl2 -R Auto -D 0.0 -f mp4 -I -X 480 -m -x level=30:cabac=0:ref=1:analyse=all:me=umh:no-fast-pskip=1:psy-rd=0,0:bframes=0:weightp=0:subme=6:8x8dct=0:trellis=0
", $inPath, $outPath);
